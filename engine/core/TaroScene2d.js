 ...
 */
var TaroScene2d = TaroEntity.extend({
	classId: 'TaroScene2d',
	...
	init: function () {
		...
		this._bounds2d.x = taro._bounds2d.x;
		this._bounds2d.y = taro._bounds2d.y;
	...
	streamSectionData: function (sectionId, data) {
		switch (sectionId) {
			...
			default:
				TaroEntity.prototype.streamSectionData.call(this, sectionId, data);
				break;
		}
	},
	...
	update: function (ctx, tickDelta) {
		if (this._ignoreCamera) {
			...
			// this._localMatrix.multiply(taro._currentCamera._worldMatrix.getInverse());
		}
	...
	_resizeEvent: function (event) {
		// Set width / height of scene to match main taro (SCENES ARE ALWAYS THE FULL IGE SIZE!!)
		if (this._autoSize) {
			this._bounds2d = taro._bounds2d.clone();
		}
